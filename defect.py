...
file_input.send_keys(r"C:\\Users\Dell 9010\Desktop\Automated-Testing-using-Selenium\\inputw.txt")          # check with input.txt and inputw.txt
...
f = open("inputw.txt", "r")                                                                              # check with input.txt and inputw.txt
